                ...
                (function() {
                    ...
                    function b(t, e) {
                        ...
                        for (var i = [], n = 2; n < arguments.length; n++)
                            i[n - 2] = s[n];
                        return null != t && (e ? !!i.some((function(e) {
                            if ("Element" === e)
                                return 1 === t.nodeType || "string" == typeof t.nodeName && "#text" !== t.nodeName && "#comment" !== t.nodeName || t.tagName && "string" == typeof t.tagName || t.setAttribute && "function" == typeof t.setAttribute;
                            if ("Text" === e)
                            ...
                            if (e.startsWith("HTML") && e.endsWith("Element")) {
                                ...
                                return t.nodeName && t.nodeName.toLowerCase() === s || t.tagName && t.tagName.toLowerCase() === s
                            }
                            return !1
                        }
                        )) || !!t.ownerDocument && i.some((function(e) {
                            var s, i;
                    ...
                    function v(t, e, s) {
                        ...
                        s.valueDiffing && (t.value && b(i, s.simplifiedElementCheck, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (i.value = t.value),
                        t.checked && b(i, s.simplifiedElementCheck, "HTMLInputElement") && (i.checked = t.checked),
                        t.selected && b(i, s.simplifiedElementCheck, "HTMLOptionElement") && (i.selected = t.selected))),
                        i
                    }
                    var w = function(t, e) {
                    ...
                    function _(t, e, s) {
                        ...
                        case s._const.addAttribute:
                            if (!i || !b(i, s.simplifiedElementCheck, "Element"))
                                return !1;
                        ...
                        case s._const.modifyAttribute:
                            ...
                            b(i, s.simplifiedElementCheck, "HTMLInputElement") && "value" === e[s._const.name] && (i.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.modifyTextElement:
                            if (!i || !b(i, s.simplifiedElementCheck, "Text"))
                                return !1;
                            s.textDiff(i, i.data, e[s._const.oldValue], e[s._const.newValue]),
                            b(i.parentNode, s.simplifiedElementCheck, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.modifyComment:
                            if (!i || !b(i, s.simplifiedElementCheck, "Comment"))
                                return !1;
                            s.textDiff(i, i.data, e[s._const.oldValue], e[s._const.newValue]);
                            break;
                        ...
                        case s._const.relocateGroup:
                            m([], new Array(e[s._const.groupLength])).map((function() {
                        ...
                        case s._const.addElement:
                            ...
                            if (!b(i = w(t, u), s.simplifiedElementCheck, "Element"))
                                return !1;
                        ...
                        case s._const.removeTextElement:
                            ...
                            var h = i.parentNode;
                            h.removeChild(i),
                            b(h, s.simplifiedElementCheck, "HTMLTextAreaElement") && (h.value = "");
                            break;
                        case s._const.addTextElement:
                            ...
                            b(i.parentNode, s.simplifiedElementCheck, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.value]);
                            break;
                        default:
                    ...
                    var D = function(t) {
                      ...
                      , C = function(t, e) {
                        return m([], new Array(t)).map((function() {
                            return e
                        }
                        ))
                    }
                      , k = function(t, e) {
                        for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = C(s.length, !1), a = C(i.length, !1), o = [], r = function() {
                            return arguments[1]
                        }, l = !1, d = function() {
                            var t = function(t, e, s, i) {
                                var n = 0
                                  ...
                                  , o = t.length
                                  , r = e.length
                                  , l = m([], new Array(o + 1)).map((function() {
                                    return []
                                }
                                ))
                                  , d = N(t, e)
                            ...
                            t ? (o.push(t),
                            m([], new Array(t.length)).map(r).forEach((function(e) {
                                return function(t, e, s, i) {
                                    t[s.oldValue + i] = !0,
                                    e[s.newValue + i] = !0
                                }(n, a, t, e)
                    ...
                    function A(t, e) {
                        void 0 === e && (e = {
                            valueDiffing: !0,
                            simplifiedElementCheck: !0
                        });
                        var s = {
                            nodeName: t.nodeName
                        };
                        return b(t, e.simplifiedElementCheck, "Text", "Comment") ? s.data = t.data : (t.attributes && t.attributes.length > 0 && (s.attributes = {},
                        ...
                        e.valueDiffing && (b(t, e.simplifiedElementCheck, "HTMLTextAreaElement") && (s.value = t.value),
                        b(t, e.simplifiedElementCheck, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : b(t, e.simplifiedElementCheck, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value),
                        b(t, e.simplifiedElementCheck, "HTMLOptionElement") && (s.selected = t.selected))),
                        s
                    }
                    ...
                    var H = {
                      ...
                      , j = function() {
                        function t(t, e, s) {
                            this.options = s,
                            this.t1 = "undefined" != typeof Element && b(t, this.options.simplifiedElementCheck, "Element") ? A(t, this.options) : "string" == typeof t ? Y(t, this.options) : JSON.parse(JSON.stringify(t)),
                            this.t2 = "undefined" != typeof Element && b(e, this.options.simplifiedElementCheck, "Element") ? A(e, this.options) : "string" == typeof e ? Y(e, this.options) : JSON.parse(JSON.stringify(e)),
                            this.diffcount = 0,
                            this.foundAll = !1,
                            this.debug && (this.t1Orig = "undefined" != typeof Element && b(t, this.options.simplifiedElementCheck, "Element") ? A(t, this.options) : "string" == typeof t ? Y(t, this.options) : JSON.parse(JSON.stringify(t)),
                            this.t2Orig = "undefined" != typeof Element && b(e, this.options.simplifiedElementCheck, "Element") ? A(e, this.options) : "string" == typeof e ? Y(e, this.options) : JSON.parse(JSON.stringify(e))),
                            this.tracker = new $
                        }
                        ...
                        t.prototype.findOuterDiff = function(t, e, s) {
                            ...
                            if (t.nodeName !== e.nodeName) {
                                ...
                                return [(new g).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, E(t)).setValue(this.options._const.newValue, E(e)).setValue(this.options._const.route, s)]
                            }
                        ...
                        t.prototype.findInnerDiff = function(t, e, s) {
                            ...
                            if (!this.options.maxChildCount || a < this.options.maxChildCount) {
                                var d = Boolean(t.subsets && t.subsetsAge--)
                                  , c = d ? t.subsets : t.childNodes && e.childNodes ? k(t, e) : [];
                            ...
                            for (var h = 0; h < a; h += 1) {
                                ...
                                h -= 1,
                                l -= 1,
                                o -= 1) : i.length < n.length ? (r = r.concat([(new g).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, E(p)).setValue(this.options._const.route, s.concat(l))]),
                                i.splice(h, 0, E(p)),
                                o -= 1) : r = r.concat([(new g).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, E(u)).setValue(this.options._const.newValue, E(p)).setValue(this.options._const.route, s.concat(l))]))),
                                l += 1
                            }
                        ...
                        t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
                            for (var a, o, r, l, d, c = function(t, e, s) {
                                var i = t.childNodes ? C(t.childNodes.length, !0) : []
                                  , n = e.childNodes ? C(e.childNodes.length, !0) : []
                                  , a = 0;
                                ...
                                if (!n || !0 !== h[v] && !0 !== u[v])
                                    if (!0 === h[w])
                                        if ("#text" === (l = p[w]).nodeName)
                                            ...
                                            !0 === u[v] ? b.push((new g).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, E(l)).setValue(this.options._const.newValue, E(f[v])).setValue(this.options._const.route, i.concat(w))) : (b.push((new g).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, E(l))),
                                            h.splice(w, 1),
                                            p.splice(w, 1),
                                            m = Math.min(h.length, u.length),
                                            w -= 1,
                                        ...
                                        m = Math.min(h.length, u.length)) : (b.push((new g).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, E(l))),
                                        h.splice(w, 0, !0),
                                        p.splice(w, 0, E(l)),
                                        m = Math.min(h.length, u.length));
                                    else if (h[w] !== u[v]) {
                                        if (b.length > 0)
                                            return b;
                                        if (r = s[h[w]],
                                        (o = Math.min(r.newValue, p.length - r.length)) !== r.oldValue && o > -1) {
                                            a = !1;
                    ...
                    const B = (t, e, s, {classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l}, {noColumnWidths: d, unhideHeader: c}) => ({
                        nodeName: "TR",
                        childNodes: t.map(( (t, n) => {
                            const l = e[n] || {
                                sortable: !0
                            };
                            if (l.hidden || "true" === t.attributes?.["data-colspan-placeholder"])
                                return;
                            const h = t.attributes ? {
                                ...t.attributes
                            } : {};
                            if (l.sortable && o && (!r.length || c) && (l.filter ? h["data-filterable"] = "true" : h["data-sortable"] = "true"),
                            l.headerClass && (h.class = u(h.class, l.headerClass)),
                            s.sort && s.sort.column === n) {
                                const t = "asc" === s.sort.dir ? i.ascending : i.descending;
                                h.class = u(h.class, t),
                                h["aria-sort"] = "asc" === s.sort.dir ? "ascending" : "descending"
                            } else
                                s.filters[n] && (h.class = u(h.class, i.filterActive));
                            if (s.widths[n] && !d) {
                            ...
                            return {
                                nodeName: "TH",
                                attributes: h,
                                childNodes: !a && !r.length || c ? l.sortable && o ? [{
                                    nodeName: "BUTTON",
                                    attributes: {
                                ...
                                childNodes: s.map(( ({row: t, index: e}) => {
                                    const s = {
                                        ...
                                        childNodes: t.cells.map(( (t, s) => {
                                            ...
                                            if (a.hidden || "true" === t.attributes?.["data-colspan-placeholder"])
                                                return;
                    ...
                    var J = U({
                      ...
                      , W = U({
                        ...
                        function p(s) {
                            ...
                            i = s,
                            n = o && o.formats;
                            for (var a = (s = i.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, (function(e, s, i) {
                                ...
                                if ("string" == typeof r) {
                                    ...
                                    this.$d = function(t, e, s, i) {
                                        try {
                                            ...
                                            var w, _ = l || 0, y = d || 0, D = c || 0, M = h || 0;
                                            return u ? new Date(Date.UTC(b, v, g, _, y, D, M + 60 * u.offset * 1e3)) : s ? new Date(Date.UTC(b, v, g, _, y, D, M)) : (w = new Date(b,v,g,_,y,D,M),
                    ...
                    const Q = (t, e) => {
                      ...
                      , X = (t, e) => {
                        ...
                        if (void 0 === s.text || void 0 === s.order)
                            switch (e.type) {
                            case "string":
                                "string" != typeof i && (s.text = s.text ?? String(s.data),
                                s.order = s.order ?? s.text);
                                break;
                            case "date":
                                e.format && (s.order = s.order ?? Q(String(s.data), e.format));
                                break;
                            case "number":
                      ...
                      , G = t => {
                        if (t instanceof Object && t.constructor === Object && t.hasOwnProperty("data")) {
                            const e = t;
                            return "string" == typeof e.data && (e.text || (e.text = e.data),
                      ...
                      , K = (t, e=void 0, s, i, n) => {
                        ...
                        if (t.headings) {
                            ...
                            Array.from(e.tHead.querySelectorAll("th")).forEach((t => {
                                ...
                                for (let a = 0; a < e; a++) {
                                    ...
                                    const e = s[r];
                                    0 === a && ("false" !== t.dataset.sortable?.trim().toLowerCase() && "false" !== t.dataset.sort?.trim().toLowerCase() || (e.sortable = !1),
                                    "false" === t.dataset.searchable?.trim().toLowerCase() && (e.searchable = !1),
                                    "true" !== t.dataset.hidden?.trim().toLowerCase() && "true" !== t.getAttribute("hidden")?.trim().toLowerCase() || (e.hidden = !0),
                                    t.dataset.type && ["number", "string", "html", "date", "boolean", "other"].includes(t.dataset.type) && (e.type = t.dataset.type,
                                    "date" === e.type && t.dataset.format && (e.format = t.dataset.format))),
                                    r++
                                }
                            }
                            ))
                        ...
                        if (t.data) {
                            ...
                            o.data = t.data.map(( (t, n) => {
                                let a, r;
                                Array.isArray(t) ? (a = {},
                                r = t) : t.hasOwnProperty("cells") && Object.keys(t).every((t => ["cells", "attributes"].includes(t))) ? (a = t.attributes,
                                r = t.cells) : (a = {},
                                r = [],
                            ...
                            o.data = Array.from(e.tBodies[0].rows).map((e => {
                                ...
                                for (; n < o.headings.length; )
                                    if (t.has(n)) {
                                        ...
                                        {
                                            const e = r[a]
                                              , o = parseInt(e.getAttribute("colspan") || "1", 10)
                                              , l = parseInt(e.getAttribute("rowspan") || "1", 10)
                                              , d = e.dataset.content ? X(e.dataset.content, s[n]) : Z(e, s[n]);
                                            e.dataset.order && (d.order = isNaN(parseFloat(e.dataset.order)) ? e.dataset.order : parseFloat(e.dataset.order)),
                                            i.push(d),
                                            l > 1 && t.set(n, {
                                                remainingRows: l - 1,
                                                cellData: d
                    ...
                    class et {
                        ...
                        sort(t, e=void 0, s=!1) {
                            ...
                            const n = !(!i || !["string", "html"].includes(i.type)) && new Intl.Collator(i.locale || this.dt.options.locale,{
                                usage: "sort",
                            ...
                            this.dt.data.data.forEach(( (t, e) => {
                                if (t.cells.some((t => "true" === t.attributes?.["data-rowspan-placeholder"]))) {
                                    for (let t = e - 1; t >= 0; t--)
                                        if (r.has(t)) {
                                            const s = r.get(t);
                                            return a[s].push(e),
                                    ...
                                    a.push([e]),
                                    r.set(e, t)
                                } else if (t.cells.some((t => t.attributes?.rowspan && parseInt(t.attributes.rowspan, 10) > 1))) {
                                    const t = a.length;
                                    a.push([e]),
                                    r.set(e, t)
                                } else {
                            ...
                            a.sort(( (s, i) => {
                                const a = (t, e) => {
                                    ...
                                    if ("true" === s.attributes?.["data-rowspan-placeholder"]) {
                                        for (let s = t - 1; s >= 0; s--) {
                                ...
                                return n && "number" != typeof r && "number" != typeof l ? n.compare(String(r), String(l)) : r < l ? -1 : r > l ? 1 : 0
                            }
                            ));
                            const l = [];
                            a.forEach((t => {
                    ...
                    s.DataTable = class {
                        ...
                        _renderPagers() {
                            ...
                            let t = ( (t, e, s, i, n) => {
                                ...
                                return n.firstLast && a.push(it(i, n.lastText, n)),
                                {
                                    nodeName: "UL",
                                    attributes: {
                        ...
                        _renderSeparateHeader() {
                            ...
                            if (e.attributes.class?.includes(this.options.classes.table) || (e.attributes.class = u(e.attributes.class, this.options.classes.table)),
                        ...
                        destroy() {
                            if (this.options.destroyable) {
                                if (this.emit("datatable.destroy:before"),
                                this.wrapperDOM) {
                        ...
                        multiSearch(t, e="search") {
                            ...
                            const i = s.map((t => this.columns.settings.map(( (e, s) => {
                                if (!e || e.hidden || !e.searchable || t.columns && !t.columns.includes(s))
                                    return !1;
                                let i = t.terms;
                            ...
                            this.data.data.forEach(( (t, e) => {
                                const n = t.cells.map(( (t, s) => {
                                    const i = this.columns.settings[s]
                                      , n = i?.searchMethod || this.options.searchMethod;
                                    let a = t;
                                    if ("true" === t.attributes?.["data-rowspan-placeholder"])
                                        for (let t = e - 1; t >= 0; t--) {
                                            const e = this.data.data[t].cells[s];
                                            if ("true" !== e.attributes?.["data-rowspan-placeholder"]) {
                                                a = e;
                                                break
                                            }
                                        }
                                    ...
                                    if (r.length) {
                                        ...
                                        ["base", "case"].includes(t) && (r = r.normalize("NFD").replace(/\p{Diacritic}/gu, "")),
                                        (i?.ignorePunctuation ?? this.options.ignorePunctuation) && (r = r.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, ""))
                                    }
                                    const l = i?.searchItemSeparator || this.options.searchItemSeparator;
                                ...
                                i.every(( (e, i) => e.find(( (e, a) => {
                                    if (!e)
                                        return !1;
                                    const o = this.columns.settings[a]
                                      , r = o?.searchMethod || this.options.searchMethod;
                                    return r ? r(e, n[a], t, a, s[i].source) : e.find((t => n[a]?.find((e => e?.includes(t)))))
                                }
                        ...
                        insert(t) {
                            ...
                            if (Array.isArray(t)) {
                                ...
                                ))) : this.data = K(t, void 0, this.columns.settings, this.options.type, this.options.format));
                        ...
                        setMessage(t) {
                            ...
                            s.attributes.class?.includes(this.options.classes.table) || (s.attributes.class = u(s.attributes.class, this.options.classes.table)),
                            this.options.tableRender) {
                    ...
                    s.exportCSV = function(t, s={}) {
                        ...
                        const i = {
                          ...
                          , a = t.data.headings.filter(( (t, e) => n(e))).map((t => {
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection)) {
                                ...
                                for (let e = 0; e < i.selection.length; e++)
                                    l = l.concat(t.pages[i.selection[e] - 1].map((t => t.row)))
                            } else
                                l = t.pages[i.selection - 1].map((t => t.row));
                        else
                            l = t.data.data;
                        let d = [];
                        if (d[0] = a,
                            ...
                            for (; i < t.cells.length; ) {
                                ...
                                if (n(i))
                                    if (r.has(s)) {
                                        ...
                                        s++,
                                        i++
                                    } else if ("true" === a.attributes?.["data-rowspan-placeholder"])
                                        i++;
                                    else if ("true" === a.attributes?.["data-colspan-placeholder"])
                                        e.push(""),
                                        s++,
                                        i++;
                                    else {
                                        const t = Number(a.attributes?.colspan || 1)
                                          , n = Number(a.attributes?.rowspan || 1)
                                          , l = o(a);
                                        e.push(l);
                                        for (let s = 1; s < t; s++)
                                            e.push("");
